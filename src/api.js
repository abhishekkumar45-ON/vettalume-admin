...
export const renameNode = (id, name, sectionKey) =>
  request(`/admin/nodes/${encodeURIComponent(id)}`, { method: 'PATCH', body: { name, section_key: sectionKey } });

export const reorderNodes = (ids) => post('/admin/nodes/reorder', { ids });
